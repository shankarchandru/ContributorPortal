define([
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        postCreate: function () {
			...
			/* : Shankar: Uncomment below lines to get map extent in javascript console
			
			var mapExtentChange = this.map.on("extent-change",lang.hitch(this,function(evt) {
				console.log("Min X: " + evt.extent.xmin );
				console.log("Min y: " + evt.extent.ymin );
				console.log("Max X: " + evt.extent.xmax );
				console.log("Max Y: " + evt.extent.ymax );
			...
			if(!user.isAdmin)
			{
				this.contributorName.value = user.username;
			}			
...
*/		 
		...
		scheduleQCJob : function () {
           //1. Title (Optional)
			...
			sessionString = "Session 1 : Sanity Results";
			sessionId = 7;			
			...
			if(!user.isAdmin)
			{
				...
				sessionString = "session " + sessionId  + " : " + user.username;
			...
			//this.createSession(this.contributorName.value).then(lang.hitch(this,function(response) {
				...
				bvParameters.fileItemId =  "idb2af88a-fc86-4f1b-8609-2ded2b663842";// Address Validation Batch Job to validate the uploaded data
