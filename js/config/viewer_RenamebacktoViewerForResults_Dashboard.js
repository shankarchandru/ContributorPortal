define([
	...
	return {
		...
		operationalLayers: [/*{
			...
			type: 'dynamic',
			url: 'http://localhost:6080/arcgis/rest/services/AddressManagement/AddressDataManagement_UploadedData/MapServer/0',
			...
			type: 'dynamic',
			url: 'http://localhost:6080/arcgis/rest/services/AddressManagement/AddressDataManagement_UploadedData/MapServer/2',
			...
			type: 'dynamic',
			url: 'http://localhost:6080/arcgis/rest/services/AddressManagement/AddressDataManagement_UploadedData/MapServer/3',
			...
			type: 'dynamic',
			url: 'http://localhost:6080/arcgis/rest/services/AddressManagement/AddressDataManagement_UploadedData/MapServer/10',
			...
			type: 'dynamic',
			url: 'http://localhost:6080/arcgis/rest/services/AddressManagement/AddressDataManagement_UploadedData/MapServer',
			title: 'Mobile DataUpload',
			options: {
				id: 'Mobile_DataUpload',
				opacity: 1.0,
				visible: true,
